...
status: executing
stopped_at: Quick 260924-n8x zamkniety; komplet wzorow rekrutacyjnych z RODO od dyrektor na stronie, dwie nowe klauzule, pytanie o klauzule 06 otwarte
last_updated: "2026-09-23T14:30:00.000Z"
last_activity: 2026-09-24
last_activity_desc: "Quick 260924-n8x: wzory od dyrektor z 2026-09-24, czyli wniosek, szesc zalacznikow i druk rezygnacji z wbudowana informacja RODO (wszystko .docx) oraz dwie nowe klauzule RODO: rekrutacja i opieka"
progress:
  total_phases: 9
  completed_phases: 6
  total_plans: 47
...
sukcesu czekaly na wejscia od Gminy, ktorych nie ma. Skrzynka podana wtedy jako odbiorca (`zlobek@` w domenie ugstromiec.pl) nie
istniala, wiec noga `to:` kazdej wiadomosci z formularza odbijala sie twardo
(placowka podala prawdziwy adres dopiero 2026-08-27). W repozytorium
...
- Domain/email split: we OWN `zlobekstromiec.pl` (public site + Resend sending domain via `send.` subdomain; DNS on Cloudflare, we control it) → form email delivered to the Gmina mailbox `publicznyzlobek@ugstromiec.pl` (given in writing 2026-08-27; it replaced an earlier address on the same domain that never existed as a mailbox), with a `cc` copy to the Urząd Gminy clerk. No `ugstromiec.pl`-DNS dependency. DKIM is a TXT record (not CNAME); MX + SPF + DMARC on our domain (see ROADMAP "Email Sending — Implementation Notes").
...
- ~~[Phase 4/6] Confirm exact recipient email~~ — **RESOLVED 2026-08-27: `publicznyzlobek@ugstromiec.pl`**, given in writing by the Urząd Gminy. It supersedes the previously "confirmed" `zlobek@` address on the same domain, which never existed as a mailbox.
- [Phase 4] NEW (soft): ask Gmina IT to allowlist our sending domain (`send.zlobekstromiec.pl`) and confirm the `publicznyzlobek@ugstromiec.pl` mailbox receives external mail; run an early end-to-end delivery test.
...
- [Phase 4 / 04-07, REWRITTEN 2026-08-27] The ban on changing the recipient is LIFTED, because its premise expired: the address it protected never existed as a mailbox, and the placowka supplied a real one in writing on 2026-08-27. The recipient is now publicznyzlobek@ugstromiec.pl and a hard-coded cc copy goes to the Urzad Gminy clerk running recruitment casework, disclosed in the klauzula (the constant and the disclosure are a pair and may never drift apart). The BCC backup devzlobekstromiec@gmail.com STAYS and so does its klauzula paragraph: delivery to the new mailbox is STILL NOT PROVEN. Proving it is one form submission after deploy plus a look in that inbox, zero deploys; until then FORM-01 stays unticked and a parent enquiry may still be landing only in the backup Gmail inbox.
- [Quick 260827-bfa] OTWARTE PYTANIE DO KLIENTKI (a): imie i nazwisko inspektora ochrony danych. Kamila Dobosz podala 2026-08-27 wylacznie adres iod@ugstromiec.pl, a art. 11 ustawy z 10 maja 2018 r. o ochronie danych osobowych wymaga udostepnienia takze imienia i nazwiska. Bez tego nazwiska LEGAL-02 nie moze sie zamknac, dokladnie tak jak A11Y-03 czeka na koordynatora dostepnosci. Znacznik PLACEHOLDER przy bloku IOD zostal zawezony do tego jednego braku, nie usuniety.
- [Quick 260827-bfa] OTWARTE PYTANIE DO KLIENTKI (b): kto jest administratorem danych. Jej tekst mowi "podmiot prowadzacy Publiczny Zlobek w Stromcu", a istniejaca klauzula formularzy mowi "Publiczny Zlobek w Stromcu, jednostka organizacyjna Gminy Stromiec". Przy ustawie o opiece nad dziecmi do lat 3 podmiotem prowadzacym zlobek publiczny jest gmina, wiec oba zdania moga wskazywac dwa rozne podmioty. OBIE wersje sa dzis opublikowane, kazda w swojej sekcji /polityka-prywatnosci, i to jest SWIADOME (D-3): uzgodnienie nalezy do administratora, nie do nas, wiec nie rozstrzygamy tego w kodzie.
...
| 260901-duo | Adres publicznyzlobek@ugstromiec.pl lamal sie na stronie glownej w SRODKU domeny i zostawial osierocone "ec.pl" w drugim wierszu, bo .item-link niesie overflow-wrap: anywhere, czyli zgode na zlamanie w dowolnym miejscu; nowy AdresEmail.svelte jest JEDYNYM miejscem renderujacym adres i niesie znacznik <wbr> zaraz po malpie, wiec jedyna dozwolona granica jest malpa, a adres nadal kopiuje sie jako jeden ciag (zaznaczenie daje 29 znakow, bez spacji i bez dywizu, czego &shy; ani <br> nie daja); wszystkie SZESC powierzchni czyta to jedno zrodlo, ze stopka wlacznie, gdzie adres CELOWO zostaje zwyklym tekstem, bo od tego zalezy zasada jednego mailto na stronie glownej; karta kontaktowa wraca od 1024 px do jednej kolumny, bo siatka dwa na dwa powstala przy CZTERECH pozycjach, a od 2026-08-18 sa TRZY i druga kolumna drugiego wiersza stala pusta, kosztem 198 px przy 1440 i 168 px przy 1024 dla adresu potrzebujacego 227 px; nowy tests/adres-email.spec.ts mierzy Range.getClientRects na WEZLACH TEKSTOWYCH, bo element opakowujacy jest w rodzicu inline-flex zblokowany i zwrocilby jeden prostokat niezaleznie od zawijania. Audyt D-4: adresu NIGDY nie bylo w gornym pasku, wiec go tam nie dodano | 2026-09-01 | 557ae36 | [260901-duo-adres-e-mail-lamie-sie-w-srodku-slowa-na](./quick/260901-duo-adres-e-mail-lamie-sie-w-srodku-slowa-na/) |
| 260921-j9c | Komplet danych przekazanych przez dyrektor 2026-09-21. SLUZBOWY NUMER 500 051 228 wraca na dziewiec powierzchni jako wartosc wylacznie w contact w site.ts, przez odwrocenie telefonicznej polowy acd6497 (numer zdjety 2026-08-18 byl jej PRYWATNA komorka, ten jest linia zlobka); asercja na stronie glownej znowu liczy odnosniki tel: i zada trzech, ale mocniej niz przed acd6497, bo porownuje kazdy href i kazdy napis z site.ts. KWOTA ZUS pada teraz jawnie: pole zus w cennik.json podaje doplate do 1 500 zl, czyli dokladnie to, co rodzic placi po obnizce, a test zada tej ROWNOSCI zamiast przepisywac kwote; HARD RULE 2 w module prozy przepisana, bo jej przeslanka (brak potwierdzonego zrodla) wygasla, a placeholder w cenniku zdjety. DWANASCIE NOWYCH DOKUMENTOW plus prawdziwy PDF uchwaly XXIII.133.2026 zamiast atrapy 623 B; nowa kategoria organizacja miedzy statut a rodo; kategoria RODO przestala byc uspiona przy NIENARUSZONEJ regule D-13; pasmo RODO otwiera sie tekstem dokumentu 08 z nowego src/lib/content/rodo.ts, ktory CELOWO nie niesie zadnego adresu, bo oba pochodza z contact. IOD NAZWANY (Michal Paprocki, iod.zlobek@ugstromiec.pl) zamyka wymog art. 11 ustawy z 10.05.2018, a klauzula 06 zastepuje tekst placowki z 2026-08-27; swiadoma rozbieznosc co do administratora, opisana w kodzie od sierpnia, zostala rozstrzygnieta przez dokumenty IOD, a nie przez nas. KADRA ma cztery role z dyrektor na pierwszym miejscu. KOORDYNATOR DOSTEPNOSCI Ewelina Remion i obie listy faktow o dostepnosci leza w nowym src/lib/content/dostepnosc.ts i renderuja sie na stubie deklaracji; schemat deklaracji z fazy 6 NIETKNIETY. Dwa znalezione bledy: wpis druk-rezygnacji.json sortowal sie przed oba wpisy rekrutacyjne i ZEPCHNAL wniosek o przyjecie dziecka z kafla na stronie glownej (kafel bierze dwa pierwsze wpisy, a kolejnosc bierze sie z nazw plikow), oraz dlugie nazwy klauzul lamaly sie na telefonie w srodku wyrazu, bo meta wiersza zajmuje 180 px niezaleznie od ekranu | 2026-09-21 | daffa06 | [260921-j9c-dane-od-dyrektor-telefon-kadra-iod-koord](./quick/260921-j9c-dane-od-dyrektor-telefon-kadra-iod-koord/) |
| 260923-mb0 | Poprawione dokumenty rekrutacyjne przekazane przez dyrektor 2026-09-23. DWIE ATRAPY ZNIKAJA: wniosek o 96 bajtach i regulamin o 630 bajtach byly szablonami Publicznego Zlobka w Starej Blotnicy i wlasnie dlatego nigdy nie zostaly opublikowane; teraz sa to wniosek dla Stromca (49 KB) i zarzadzenie nr 29.2026 Wojta Gminy Stromiec (305 KB), ktorego wersja to 01.04.2026, czyli data zarzadzenia, a nie data podmiany. PIEC NOWYCH ZALACZNIKOW 2 do 6 plus druga wersja druku rezygnacji, juz bez daty 31.10.2026 wpisanej na sztywno, czyli osiem pozycji w kategorii rekrutacja zamiast trzech. NUMERACJA IDZIE ZA NAGLOWKIEM W PLIKU, NIE ZA NAZWA PLIKU: trzy pliki przyszly pod cudzym numerem (Zalacznik 4 niesie Zalacznik 2, Zalacznik 5 niesie Zalacznik 3, Zalacznik 3 niesie Zalacznik 4), a naglowki zgadzaja sie z par. 8 i par. 9 regulaminu, wiec kazda kopia byla poprzedzona sprawdzeniem pierwszej linii ekstraktu. ZALACZNIK 1 WSTRZYMANY I TO JEST GLOWNA RZECZ DO ZGLOSZENIA: jego naglowek mowi o Gminie Stromiec, ale w tresci stoi „zamieszkuje/my na obszarze Gminy Stara Blotnica", wiec rodzic podpisalby nieprawdziwe oswiadczenie pod rygorem odpowiedzialnosci karnej, ktory ten sam druk przywoluje; numer 1 zostaje wolny, a brakuje akurat kryterium wartego 50 punktow. Przy zadnym dokumencie w sklepie nie ma juz znacznika tresci zastepczej, a w calym src/lib/content zostal JEDEN taki znacznik i jest nim wpis aktualnosci, nie kafelek w w-skrocie.json, jak zakladal plan. Dwa odstepstwa: nazwy zalacznikow lamaly sie przy 390 px w srodku wyrazu („wychowywan / iu"), bo dwutorowa siatka z quicka 260921-j9c trafila tylko na /dokumenty, a obie trasy maja wlasna kopie tych regul CSS; oraz asercja sekcji 10.3 zakazywala ciagu 01.04.2026 w calym HTML, a to jest data samego zarzadzenia i stoi teraz jako „wersja z 01.04.2026", wiec sprawdzenie zostalo zawezone do tego, ze kazde wystapienie archiwalnej daty MUSI byc wersja dokumentu, co sprawdzono doswiadczalnie sonda 27.04.2026. Otwarte dla dyrektor: rozbieznosc par. 9 („gospodarstwo rolne") wobec druku i par. 8 („dzialalnosc gospodarcza"), nierozstrzygniety okres przechowywania nagran (7 dni w klauzuli 07 wobec 5 dni w piktogramie 09) oraz to, ze nabor podstawowy 2026/2027 zamknal sie 27.04.2026, a strona mowi „nabor trwa przez caly rok" | 2026-09-23 | 7263fc9 | [260923-mb0-poprawione-dokumenty-od-dyrektor-podmian](./quick/260923-mb0-poprawione-dokumenty-od-dyrektor-podmian/) |
| 260924-n8x | Wzory dokumentow od dyrektor z 2026-09-24: osiem formularzy rekrutacyjnych (wniosek na rok 2026/2027, zalaczniki 1 do 6, oswiadczenie o rezygnacji) podmienione na wersje .docx z wbudowana informacja RODO, sciezki plikow wyrownane do slugow sklepu; dwie NOWE klauzule w kategorii RODO (rekrutacja, opieka nad dzieckiem); klauzula 06 z 21.09 zostaje do decyzji dyrektor, bo cytuje ja /polityka-prywatnosci. Tryb gsd-fast, bez planera i wykonawcy | 2026-09-24 | 0de5239 | [260924-n8x-wzory-dokumentow-od-dyrektor-2026-09-24-](./quick/260924-n8x-wzory-dokumentow-od-dyrektor-2026-09-24-/) |
