		...
		{#if kopiaBledu !== null}
			...
			<div class="panel awaria" role="alert" tabindex="-1" bind:this={panelBleduEl}>
				...
				{:else if !podsumowaniePol}
					<!-- Two routes again since 2026-09-21 (site.ts). This is the send-failure
					     escape hatch, so it has to lead somewhere real, and for the month the
					     site published no number the inbox was all that was left. -->
